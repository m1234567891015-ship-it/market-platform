...
MINIFY_ASSET_VERSION = "td18-minify-5da203183f90e574"
...
def verify_effective_headers_and_assets(pages: dict[str, PageAssets], full_esm: bool = False) -> dict:
    ...
    expected_cache_version = f"market-pulse-swr-{FULL_ESM_ASSET_VERSION}" if full_esm else "market-pulse-swr-20260901-td18-minify-5da203183f90e574"
    require(
