...
def wire_page(path: Path) -> bool:
    ...
    patterns = [
        (
            b'<script src="common-runtime.min.js?v=td18-minify-381f82f1f41aa0e0"></script>\r\n'
            b'<script src="route-bundle.min.js?v=td18-minify-381f82f1f41aa0e0"></script>\r\n'
...
def main() -> None:
    ...
    for path in pages:
        raw = path.read_bytes()
        if b"common-runtime.min.js?v=td18-minify-381f82f1f41aa0e0" in raw or b"derivatives-status-esm-loader.js" in raw:
