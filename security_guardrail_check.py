...
def check_dangerous_functions() -> None:
    ...
    for filename in ("app.py", "security.py", "cache.py", "fetchers.py", "builders.py", "parsers.py", "derivatives_store.py", "market_config.py"):
...
def check_hardcoded_secrets() -> None:
    candidates = ["app.py", "security.py", "cache.py", "fetchers.py", "builders.py", "parsers.py", "market_config.py", "derivatives_store.py", "app.js", "derivatives-ui.js"]
